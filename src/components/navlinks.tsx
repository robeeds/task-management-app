...
export default function NavLinks() {
    return (
        <div className="flex flex-1 gap-4 flex-row justify-center md:justify-start md:flex-col md:items-start">
            <motion.button className="flex flex-row items-center" whileHover={{ scale: 1.1 }}>
